...
# select * from orders where orderId = "90";
SELECT COUNT(orderId) FROM orders WHERE orderId = "1";
...
insert into orderInfo(orderId, productId) values("1","1");
select * from orderInfo;


select * from shoppingCart;
delete from shoppingCart where userId="5";

select * from orders;
select * from orderInfo;
SELECT COUNT(productId) FROM shoppingCart WHERE productId =90;
select productQuantity from shoppingCart where productId="2";
update shoppingCart set productQuantity= 7 where productId="2";
